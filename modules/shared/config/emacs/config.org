...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "alexdrydew"
    user-mail-address "alexdrydew@toloka.ai")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/alexdrydew/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/alexdrydew/bin" "/profile/bin" "/Users/alexdrydew/.npm-packages/bin" "/Users/alexdrydew/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
